...
public class VisualizarDadosTecnMensais extends javax.swing.JFrame {
    ...
    public VisualizarDadosTecnMensais() {
        ...
        this.setTitle("SGPL - " + atual.getNome() + " - Dados Técnicos Mensais");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarDadosTecnMensais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
